...
haste.prototype.configureButtons = function() {
  ...
  this.buttons = [
    ...
    },
    {
      ...
      label: 'New',
      shortcut: function(e) {
        return e.metaKey && e.keyCode === 69;
      },
      shortcutDescription: '⌘ + e',
      action: function() {
    ...
    },
    {
      ...
      shortcut: function(e) {
        return _this.doc.locked && e.metaKey && e.keyCode === 68;
      },
      shortcutDescription: '⌘ + d',
      action: function() {
    ...
    },
    {
      ...
      label: 'Just Text',
      shortcut: function(e) {
        return e.metaKey && e.shiftKey && e.keyCode === 82;
      },
      shortcutDescription: '⌘ + shift + r',
      action: function() {
...
haste.prototype.configureButton = function(options) {
  ...
  options.$where.click(function(e) {
    e.preventDefault();
...
haste.prototype.configureShortcuts = function() {
  ...
  $(document.body).keydown(function(e) {
    ...
    for (var i = 0 ; i < _this.buttons.length; i++) {
      ...
      if (button.shortcut && button.shortcut(e)) {
        e.preventDefault();
        button.action();
        return;
      }
